![Cover](Cover.png)
**Para la versión más reciente e infomación adicional, por favor consulte el sitio web del proyecto en**

<https://www.owasp.org/index.php/OWASP_SAMM_Project>

### **_Agradecimientos_**

Este documento fue creado originalmente bajo el proyecto OpenSAMM Project liderado por Pravir Chandra (chandra@owasp.org), un consultor de seguridad de software independiente. La creación del primer borrador fue posible gracias a la financiación de Fortify Software, Inc. Desde la versión inicial de SAMM, este proyecto ha sido parte del Proyecto Abierto de Seguridad de Aplicaciones Web (OWASP por sus siglas en inglés). El documento original es mantenido y actualizado bajo el proyecto OpenSAMM Project dirigido por Sebastien Deleersnyder, Bart De Win y Brian Glas. Gracias también al aopyo de muchas organizaciones que se enumeran en la contraportada.

### **_Contribuyentes y Revisores_**

Este trabajo no hubiera sido posible sin el soporte de muchos revisores y expertos que ofrecieron contribuciones y retroalimentación crítica.
...
### Licencia
Este trabajo está licenciado bajo la licencia Creative Commons Attribution-Share Alike 4.0 License. Para ver una copia de esta licencia, visite <https://creativecommons.org/licenses/bysa/4.0/>, envíe un correo electrónico a <info@creativecommons.org>, o envíe una carta a Creative Commons, PO Box 1866, Mountain View, CA 94042.
###![CC Logo](CC_Logo.png)

# Resumen Ejecutivo

El Modelo de Madurez del Aseguramiento de Software (SAMM, por sus siglas en inglés) es un marco de trabajo abierto que ayuda a las organizaciones a formular e implementar una estrategia de seguridad de software que se adapta a los riesgos específicos que enfrenta la organización. Los recursos proporcionados por SAMM ayudarán en:

✦ Evaluar las prácticas de seguridad de software existentes de una organización.

✦ Crear un programa de garantía de seguridad de software equilibrado y con iteraciones bien definidas. 

✦ Demostrar mejoras concretas a un programa de garantía de seguridad de software.

✦ Definir y evaluar actividades relacionadas con la seguridad en una organización.

La versión 1.1 de SAMM amplió y reestructuró a su predecesora con cuatro recursos complementarios: este documento que describe el modelo básico de SAMM, la Guía práctica que explica cómo aplicar el modelo, la Guía de inicio rápido para acelerar el aprendizaje y la adopción, y las herramientas que proporcionan una automatización simple de la recopilación de datos, métricas y gráficos. Además, se ha cambiado el nombre de varios elementos para representar mejor su propósito.
...
✦ No existe una receta única que funcione para todas las organizaciones: un marco de trabajo en seguridad de software debe ser flexible y permitir que las organizaciones adapten sus elecciones en función de su tolerancia al riesgo y la forma en que construyen y utilizan el software.

✦ La guía relacionada con actividades de seguridad debe ser preceptiva: todos los pasos para crear y evaluar un programa de aseguramiento deben ser simples, bien definidos y medibles. Este modelo también proporciona plantillas de hoja de ruta para tipos comunes de organizaciones.
...
La base del modelo se construye sobre las funciones básicas del negocio del desarrollo de software, a las que se les vinculan prácticas de seguridad (ver diagrama a continuación). Los componentes básicos del modelo son los tres niveles de madurez definidos para cada una de las doce prácticas de seguridad. Estos definen una amplia variedad de actividades que una organización podría abordar para reducir los riesgos de seguridad y aumentar la seguridad del software. Se incluyen detalles adicionales para medir el rendimiento exitoso de la actividad, comprender los beneficios asociados al aseguramiento, estimar constos de personal y otros.
